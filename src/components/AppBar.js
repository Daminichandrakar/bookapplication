...
class PrimarySearchAppBar extends Component {
  ...
  goToCart = () => {
    if (this.props.history.location.pathname === "/BookStoreFronPage")
      this.props.goToCart()
  }
  ...
  homePage = (event) => {
    if (this.props.history.location.pathname !== "/BookStoreFronPage") {
      //  this.props.homePage()
    this.props.history.push("/BookStoreFronPage");
    }
  }
      ...
      <div>
        <AppBar position="static" className={classes.appBar}>
          ...
          <Grid container className={classes.gridDiv}>
            ...
            <div className={(this.props.history.location.pathname === "/BookStoreFronPage") ? classes.search : "hidden"}>
